...
<header id="header" class="header">
		<nav class="navbar navbar-md top_nav"><!--toppest nav starts here-->
			...
			<div class="search_bar col-md-5">
				...
				<div class="top_nav_btn_col">
				<a href="register_seller.php" class="nav-link registration_btn top_nav-btn">Register As Seller</a>
			</div>
			<div class="top_nav_btn_col">
			<?php
				if (!isset($_SESSION['customer_email'])) {
					...
					echo "<a href='my_account.php'  class='nav-link top_nav-btn'>My Account</a>";
				}
				?>
			</div>
			<div class="top_nav_btn_col">
